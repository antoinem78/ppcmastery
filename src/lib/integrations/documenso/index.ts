  ...
  const createRes = await api("/documents", {
    ...
    body: JSON.stringify({
      ...
      meta: {
        ...
        // Typed (stylised name) + drawn signatures; upload disabled (unnecessary
        // for a service agreement). Typed renders instantly in the field; drawn
        // stays available for signers who prefer a real scrawl.
